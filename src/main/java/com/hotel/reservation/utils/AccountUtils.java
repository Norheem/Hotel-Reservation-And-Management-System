...
public class AccountUtils {
    ...
    public final static String RESERVATION_CREATED_SUCCESS_CODE = "009";

    public final static String RESERVATION_CREATED_SUCCESS_MESSAGE = "Room Reservation has been booked successfully";
    ...
    public final static String ROOM_RESERVATION_BOOKED_SUCCESS_MESSAGE = "Room Reservation has been booked successfully";

    public static final String ACCOUNT_EXISTS_CODE = "015";

    public static final String ACCOUNT_EXISTS_MESSAGE = "This user already has an account created";

    public final static String ROOM_DETAILS_SUCCESS_CODE = "016";

    public final static String ROOM_DETAILS_SUCCESS_MESSAGE = "Room has been reserved successfully";

    public static final String CREATE_PAYMENT_SUCCESSFUL_CODE = "017";

    public static final String CREATE_PAYMENT_SUCCESSFUL_MESSAGE = "Payment Creation Successful";
